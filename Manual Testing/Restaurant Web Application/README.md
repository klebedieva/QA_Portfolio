...
|---|---|
| Test Plan | Defines the project scope, objectives, test strategy, environment, deliverables, entry and exit criteria, risks, and schedule. |
| Test Cases | 43 functional E2E test cases covering category, search, price, dietary, and combined filters. |
| Requirements | Category-filtering requirement documented in Squash TM. |
| Traceability | Category-filtering test cases linked to the corresponding requirement in Squash TM. |
| Bug Reports | 4 defects documented separately with severity, priority, reproduction steps, actual and expected results, and supporting evidence. |
| Test Summary Report | Presents execution results, failed scenarios, defect distribution, risks, recommendations, and the final testing conclusion. |
